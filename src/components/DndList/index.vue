  ...
  <div class="dndList">
      ...
      <draggable :list="list1" :options="{group:'article'}" class="dragArea">
        <div :key="element.id" class="list-complete-item" v-for="element in list1">
          ...
          <div style="position:absolute;right:0px;">
            <span @click="deleteEle(element)" style="float: right ;margin-top: -20px;margin-right:5px;">
    ...
    <div :style="{width:width2}" class="dndList-list">
      ...
      <draggable :list="list2" :options="{group:'article'}" class="dragArea">
        <div :key="element.id" class="list-complete-item" v-for="element in list2">
          <div @click="pushEle(element)" class="list-complete-item-handle2">{{ element.id }} [{{ element.author }}] {{
            element.title }}
          </div>
        </div>
      </draggable>
